...
if(UWPX_PUSH_SERVER_STATIC_ANALYZE)
    if(UWPX_PUSH_SERVER_ENABLE_LINTING)
        message(FATAL_ERROR "Linting and the GCC static analysis can not be enabled at the same time! Disable either UWPX_PUSH_SERVER_STATIC_ANALYZE or UWPX_PUSH_SERVER_ENABLE_LINTING.")
    endif()
